export const settingsNav = [
  ...
  { id: 'channels', label: 'Channels', path: 'email', chevron: true },
  { id: 'inbox', label: 'Inbox', chevron: true },
  { id: 'lifecycle', label: 'Conversation lifecycle', path: 'lifecycle', chevron: true },
  { id: 'tags', label: 'Conversation tags', path: 'tags', chevron: true },
  { id: 'assignment', label: 'Assignment', path: 'assignment', chevron: true },

-- Public form / API incoming path must set channel_type (NOT NULL after production channel migration).
-- Without it, handle_incoming_message INSERT fails and PostgREST surfaces a generic 500.

-- Incoming message transaction safety:
-- - prevent duplicate customers within organization by normalized email
-- - prevent multiple open conversations per customer
-- - provide idempotent incoming message RPC wrapper
...
create table if not exists public.incoming_message_idempotency (
